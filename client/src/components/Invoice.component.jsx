...
import { addInvoice, getcustomers,getInvoiceNumber } from '../services'

function Invoice({width, navExpanded, setNavExpanded,notify}){
            ...
            <div>
                <div className="container-fluid py-4 h-100 Invoice-wrapper">
                    <div className="d-flex justify-content-center row">
                        <div className="col-md-11  col-lg-6 shadow p-3 rounded-3 bg-white invoice-main">
                            <div className="p-3">
                                <div className="row">
                                ...
                                <hr />
                                <div className="d-flex justify-content-center align-item-center mb-3 invoice-save-btn"><button className="btn btn-danger invoice-save-btn" type="button" onClick={handleSubmit}>Save</button></div>
                            </div>
                        </div>
                    </div>
                </div>
